{{-- <x-my-layout>
    <h1 class="h1-responsive text-center">Ürün Oluştur</h1>

    <x-forms.form class="max-w-2xl mx-auto space-y-6" method="POST" action="/product" enctype="multipart/form-data">
        ...
        <x-forms.button>Gönder</x-forms.button>
    </x-forms.form>
</x-my-layout> --}}
